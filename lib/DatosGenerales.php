...
// Esta es la variable que indica el host del servidor Postgres
	...
	$_SESSION["_HOST"] = "10.150.0.71";
	//$HOST = "192.168.1.8";10.150.0.21
	//Puerto
	...
	$_SESSION['_TITULO_SIS_CORTO']="ERP BOA";
	$_SESSION['_NOMBRE_SIS']="ERP BOA 2";
	$_SESSION['_REP_NOMBRE_SISTEMA']='ERP BOA';
	...
	$_SESSION['_DIR_FAV_ICON']='../../../lib/imagenes/logos/boa.ico';
    ...
    //$_SESSION['_MAIL_USUARIO'] = 'userComunicados';
    //$_SESSION['_MAIL_USUARIO'] = 'azure_92f1fd552c24007268a8c9ebb63653c2@azure.com';
    //$_SESSION['_MAIL_USUARIO'] = 'usrNotificaciones';
    //$_SESSION['_MAIL_USUARIO'] = 'erpboa';
	$_SESSION['_MAIL_REMITENTE'] = 'azure_012d0e9c9bff12a4ebf710ca2fa21260@azure.com';
	//$_SESSION['_MAIL_REMITENTE'] = 'userComunicados';
	//$_SESSION['_MAIL_REMITENTE'] = 'azure_92f1fd552c24007268a8c9ebb63653c2@azure.com';
	//$_SESSION['_MAIL_REMITENTE'] = 'usrNotificaciones';
	//$_SESSION['_MAIL_REMITENTE'] = 'erpboa';
    $_SESSION['_MAIL_PRUEBAS'] = 'franklin.espinoza@boa.bo';
    //$_SESSION['_MAIL_PASSWORD']='boa2013%';
    $_SESSION['_MAIL_PASSWORD'] = 'sgB04Us3r5mtp';
    //$_SESSION['_MAIL_PASSWORD'] = 'C0mun1c4d05';
	//$_SESSION['_MAIL_PASSWORD'] = 'sgB045y5t3m$';
	//$_SESSION['_MAIL_PASSWORD'] = 'N0t1f1c4c10n3s';
	//$_SESSION['_MAIL_PASSWORD'] = 'boa2019%';
    ...
    $_SESSION['_FTP_INGRESOS_PASS']="Passw0rd";*/
		//$_SESSION['_FTP_INGRESOS_SERV']="172.17.45.4"; en fecha 24/6/2019 cae el servicio del servidor, por tal motivo se cambia
    $_SESSION['_FTP_INGRESOS_SERV']="172.17.58.28";
