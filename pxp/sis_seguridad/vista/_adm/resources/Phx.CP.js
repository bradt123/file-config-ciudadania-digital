...
Phx.CP=function(){
    var menu,hd,mainPanel,win_login,sw_auten=false,sw_auten_veri=false,estilo_vista, form_digital;
    ...
    return{
        ...
        iniciarLogin:function(x,regreso,z){
          //console.log('prueba_digital', window.location.search.substring(1));
            Ext.QuickTips.init();
           ...
           win_login = new Ext.Window({
            ...
            form_digital =  new Ext.form.FormPanel({
              ...
              items: [
                {
                  ...
                  width: 300,
                  height: 170,
                  html: "<img style='max-width:100%;height:auto;' src='../_adm/images/logo-ciudadania.png' alt='Logo'/>",
              }],
              buttons: [{
                  text:'<span style="color:#291687;font-size:15px;font-weight:bold;">Ingresar</sapn>',
                  style: {
                  position:'absolute',
                  right: 100,
                  top: 150,
                  ...
                  handler:Phx.CP.onDigital
              }],
              keys:[{ key:Ext.EventObject.ENTER, handler: Phx.CP.onDigital }]
             });

            this.win_login = win_login;
            this.form_digital = form_digital;
        ...
        onDigital: function(d){
          window.location.href = 'getDataUrlERP.php';
          // var dt = getCodeUrl('code');
          // console.log('return ', dt);

        },
        dataConectERP: function(data){
            console.log('dataerp', data);
            if (data != undefined){
                sw_auten_veri=false;
                if(data.success){
                    // copia configuracion inicial recuperada
                    Ext.apply(Phx.CP.config_ini,data);
        ...
        entrar:function(){
            ...
            console.log('login',sw_auten_veri);
            if(!sw_auten_veri){
                sw_auten_veri=true;
                var ajax={
                    success:function(resp){
                ...
                if(form_login.getForm().isValid()){
                    ...
                    console.log('encription', Phx.Encriptacion);
                    Ext.Ajax.request({
                        url:form_login.url,
                        params:{
                            _tipo:'auten',
